class GameSessionsController < ApplicationController
  ...
  def game_session_params
    params.require(:game_session).permit(:game_id, :session_name, :date, :time, :address, :is_smoke_free, :is_family_friendly, :has_drinks, :has_food, :capacity, :is_recurrent_boolean)
  end
end
